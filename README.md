...
|__-k__|__프로세스 kill -k 입력 후 종료할 PID입력 signal을 입력하라고 하면 kill signal인 9를 입력__|
|__-a__|__메모리 사용량에 따라 정렬__|
|__-b__|__Batch 모드 작동__|
|__-f__|__sort field 선택 화면 >> q 누르면 RES 순으로 정렬__|
...
+ __SHR 옆에 있는 S 항목으로 볼 수 있음__
  ...
  + __S :__ ___Sleeping___ __상태, 요청한 리소스를 즉시 사용 가능__
